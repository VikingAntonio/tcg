...
function startAuctionTimer(auction) {
    ...
    const update = () => {
        ...
        if (distance > (24 * 60 * 60 * 1000)) {
            ...
            $miniTimer.html(`<span class="today-label">¡Termina Hoy!</span><br><span class="timer-value">${timeStr}</span>`);
            if ($modalTimer) $modalTimer.html(`<span class="today-label">¡Termina Hoy!</span><br><span class="timer-value" style="font-size: 1.5rem; display: block;">${timeStr}</span>`);
